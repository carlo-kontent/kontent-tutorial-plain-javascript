...
.items()
  ...
  .then(response => {
    ...
    response.data.items[0].elements.presentations.linkedItems.forEach(item => {
      ...
      const speakerLink = createElement(
        ...
        'speaker-link',
        'href',
        './speaker.html#' + item.elements.speakers.linkedItems[0].elements.speaker_url.value
      );      
    ...
    const teaser = createElement(
      ...
      const avatar = createElement(
        ...
        'avatar',
        'src',
        item.elements.speakers.linkedItems[0].elements.avatar.value[0].url + '?w=100&h=100'
      );  
